...
{
    cout << "\n_" << endl;
        cout << "_WELCOME TO INDIAN RAILWAYS_" << endl
             << endl;
    ...
    case 2:
    {
        ...
        case 1:
        {
            string uid, upass;
            cout << "" << endl;
            cout << "_CREATING NEW ACCOUNT" << endl;
            cout << "\nEnter the New ID: ";
            cin >> uid;
            cout << "\nEnter Password: ";
            cin >> upass;
    ...
    case 3:
    {
        ...
        cout << "Thanks for using Indian Railways" << endl
             << endl;
        exit(0);
    }
    }
...
public:
    ...
    {
        cout << "\n__" << endl;
        cout << "_WELCOME TO E-CATERING SERVICE" << endl
             << endl;
...
void mainMenu()
{
    ...
    case 2:
    {
        cout << "Book a ticket in this section_" << endl
             << endl;
        r.trains();
        break;
    }
    ...
    case 3:
    {
        cout << "_Getting your Ticket" << endl
             << endl;
        t.Bill();
...
void mainMenu2()
{
    ...
    while (true) {
        ...
        case 2:
            {
                cout << "Book a ticket in this section_" << endl << endl;
                r.trains();
                mainMenu2();
                break;
            }
        case 3:
            {
                cout << "_Getting your Ticket" << endl << endl;
                t.Bill();
